...
alabama = turtle.Turtle('square')
alabama.penup()
alabama.goto(-380, -300)
alabama.turtlesize(4)
alabama.hideturtle()
alabama.write('Alabama')
#alabama.goto(-340, 300)c
#alabama.setfillopacity(50)
